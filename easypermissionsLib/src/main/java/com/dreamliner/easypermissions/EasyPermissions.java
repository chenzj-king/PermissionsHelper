 ...
 */
package com.dreamliner.easypermissions;
...
public class EasyPermissions {
    ...
    public static String[] getDeniedPermissions(Context contexts, String[] perms) {
        ...
        denieds = new String[deniedList.size()];
        for (int i = 0; i < deniedList.size(); i++) {
            denieds[i] = deniedList.get(i);
        }
        return denieds;
    }
